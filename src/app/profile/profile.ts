                ...
                <mat-card-content>
                  <div class="profile-picture-section">
                    ...
                    <div class="avatar-actions">
                      ...
                      <button mat-button (click)="removeProfilePicture()" *ngIf="user.profilePicture">
            ...
            <div class="tab-content">
              <mat-card class="account-info-card">
                <mat-card-header>
                  ...
                  <mat-card-subtitle>View your account details</mat-card-subtitle>
                </mat-card-header>
                <mat-card-content>
                  <div class="info-grid">
                    <div class="info-item">
                    ...
                    <div class="info-item" *ngIf="user.createdAt">
                      ...
                      <div class="info-content">
                        ...
                        <span class="info-value">{{ user.createdAt | date:'fullDate' }}</span>
                      </div>
                    </div>
                    ...
                    <div class="info-item" *ngIf="user.lastActivity">
                      ...
                      <div class="info-content">
                        ...
                        <span class="info-value">{{ user.lastActivity | date:'medium' }}</span>
                      </div>
                    </div>
...
export class ProfileComponent implements OnInit, OnDestroy {
  ...
  private updateProfilePicture(profilePicture: string): void {
    this.authService.updateUserProfile({ profilePicture }).subscribe({
      ...
      error: () => {
        this.snackBar.open('An error occurred while updating profile picture.', 'Close', {
          duration: 3000,
          panelClass: ['error-snackbar']
        });
      }
  ...
  removeProfilePicture(): void {
    this.authService.updateUserProfile({ profilePicture: undefined }).subscribe({
      next: (success) => {
        if (success) {
          this.snackBar.open('Profile picture removed successfully!', 'Close', {
            duration: 3000,
            panelClass: ['success-snackbar']
          });
        }
